...
\begin{document}
	...
	\begin{center}
		\fbox{\begin{minipage}[h!]{\textwidth}
				\centering
				The project aims to simulate an electric machine and show that the numerical solution gives the solution to the differential equation.
		\end{minipage}}
	\end{center}
	\input{sections/introduction}
	\newpage
	% \input{sections/simulation.tex}
	\input{sections/constantstepmethod.tex}
	\newpage
	\input{sections/variablestepmethod.tex}
	% \newpage
